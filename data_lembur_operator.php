   ...
   <div class="table-responsive">
                    ...
                    <th>Status</th>
                                    ...
                                    <tbody>
                                      ...
                                      <?php
$lembur=mysql_query("SELECT suratjalan.*, karyawan.* FROM suratjalan LEFT JOIN karyawan ON karyawan.nik_karyawan = suratjalan.nik_karyawan ORDER BY suratjalan.inc DESC 
 ");
		$i=1;	
		while ($p=mysql_fetch_array($lembur)){
		 $tanggal = tgl_indo($p[tgl_suratjalan]);
