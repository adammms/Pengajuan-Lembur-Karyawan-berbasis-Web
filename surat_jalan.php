...
<div class="col-sm-16">
 ...
 <div class='panel-heading'><span class='glyphicon glyphicon-user'></span> <b>Data karyawan</b>
 <span class='glyphicon'></span>
   ...
   <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <?php                     
$lembur=mysql_query("SELECT * FROM karyawan where departement ='$_SESSION[deparment]' ORDER BY nik_karyawan ASC");
		$i=1;	
		...
		echo"<tr>
			  ...
			  <td><center><input type='checkbox' name='cek[]' value='$p[nik_karyawan]' class='required' title='Mohon Pilih Karyawan.'></center></td>";
 ...
 <span class='glyphicon'></span>
   ...
   <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <?php                     
$lembur=mysql_query("SELECT * FROM karyawan ORDER BY nik_karyawan ASC");
		$i=1;	
		while ($p=mysql_fetch_array($lembur)){
		echo"<tr>
              <td>$i</td>
...
<div class="col-sm-16">
 <div class='panel panel-default'>
    <div class='panel-heading'>
	<span class='glyphicon glyphicon-user'></span> <b>Data Lembur</b>
	</div>
